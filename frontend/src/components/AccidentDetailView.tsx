import { ArrowLeft, MapPin, Calendar, AlertTriangle, Image as ImageIcon } from 'lucide-react';
...
export default function AccidentDetailView({ accident, onBack }: AccidentDetailViewProps) {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Reported on {date.toLocaleDateString()} at {date.toLocaleTimeString()}
          </p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          {analysisData && (
            <Card className="p-6">
              <h3 className="mb-4 text-lg font-semibold">AI Analysis Results</h3>
              ...
              {analysisData.indicators && analysisData.indicators.length > 0 && (
                <div className="mb-4">
                  <h4 className="mb-2 text-sm font-medium">Detected Indicators</h4>
